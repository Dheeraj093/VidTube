...
const Video = () => {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      dispatch(like(loggedInUser.user?._id));
    } catch (error) {
      console.log(error);
      Swal.fire({
        icon: "error",
  ...
  const handleDislike = async () => {
    ...
    try {
      ...
      dispatch(dislike(loggedInUser.user?._id));
    } catch (error) {
      console.log(error);
      Swal.fire({
        icon: "error",
  ...
  const handleSubscription = async () => {
    ...
    try {
      loggedInUser.user.subscribedUsers.includes(channel?._id)
        ...
        <Details>
          ...
          <Buttons>
            <Button onClick={handleLike}>
              {currentVideo &&
              currentVideo.likes?.includes(loggedInUser.user?._id) ? (
                <ThumbUpIcon />
              ) : (
                <ThumbUpOutlinedIcon />
              )}{" "}
            ...
            <Button onClick={handleDislike}>
              {currentVideo &&
              currentVideo.dislikes?.includes(loggedInUser.user?._id) ? (
                <ThumbDownIcon />
              ) : (
